"""
    Day 73 is about Dunder Methods in Python...
        Magic/Dunder Methods:
            ...
            allow you to customize the behavior of your classes. They are
            used to implement special methods such as the addition,
            subtraction, and comparison operators, as well as more
            ...
            __init__ method:
                ...
                you typically define any instance variables that you need.
                Also called the "constructor," we have discussed this method already.
...
print(e)       # This will call __str__() if present or else call __repr__()
print(str(e))
print(repr(e))

e()  # This will call __call__() if available or else throw an error
