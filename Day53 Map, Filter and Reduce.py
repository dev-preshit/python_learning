"""
    #Day 53 is about Map, Filter and Reduce in python...
        ...
        map():
            ...
            Lambda function will also work...
            Will return a map object and will be need to typecast it into list, tuple, or set.
        ...
        filter():
            ...
            Lambda function will also work...
            Will return a filter object and will be need to typecast it into list, tuple, or set.
        
        reduce():
            The reduce function is a higher-order function that applies a function to a
            sequence and returns a single value. It is a part of the functools module in Python
            Syntax:
                reduce(function,iterable)
            Lambda function will also work...
            Will return a reduce value and will not be need to typecast it into list, tuple, or set
